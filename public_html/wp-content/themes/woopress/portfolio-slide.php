...
<div class="slide-item post-slide thumbnails-x <?php echo $catsClass; ?>">
	<div class="post-news">
		<?php if (has_post_thumbnail( $postId ) ): ?>
			...
			<img data-src="<?php echo $image[0]; ?>" class="owl-lazy" />
			<div class="zoom">
				<div class="btn_group">
				<?php if($lightbox): ?><a href="<?php echo etheme_get_image(get_post_thumbnail_id($postId)); ?>" class="btn btn-black xmedium-btn" rel="lightbox"><span><?php esc_html_e('View large', 'woopress'); ?></span></a><?php endif; ?>
