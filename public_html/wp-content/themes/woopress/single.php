					...
					<article <?php post_class('blog-post post-single'); ?> id="post-<?php the_ID(); ?>" >
                        ...
                        <?php if($post_format != 'quote'): ?>
                        	...
                        	<?php if(etheme_get_option('blog_byline')): ?>
                                <div class="meta-post">
                                        ...
                                        <?php esc_html_e('by', 'woopress');?> <span class="vcard author"> <span class="fn"><?php the_author_posts_link(); ?></span></span>
						...
						<?php if(etheme_get_option('post_share')): ?>
							<div class="share-post">
								<?php echo do_shortcode('[share title="'.__('Share Post', 'woopress').'"]'); ?>
							</div>
						<?php endif; ?>
						...
						<?php if(etheme_get_option('about_author')): ?>
							<h4 class="title-alt"><span><?php esc_html_e('About Author', 'woopress'); ?></span></h4>
