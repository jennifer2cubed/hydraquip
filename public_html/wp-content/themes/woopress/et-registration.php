                        ...
                        <div class="content <?php echo $content_span; ?>">
                               <?php
                                if(get_option('users_can_register') || get_site_option( 'registration', 'none' ) == 'user') {
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="content-box">
                                                <h3 class="title"><span><?php esc_html_e('Create Account', 'woopress'); ?></span></h3>
                                                <div id="result"></div> 
                                    ...
                                    <span class="error"><?php esc_html_e('Registration is currently disabled. Please try again later', 'woopress' ); ?> </span>
                                    <?php }
                                ?>
                        </div>
