              ...
              echo '<div id="option-tree-settings-api">';
                ...
                echo '<div id="option-tree-sub-header">';
                   ...
                   // echo '<pre>';
                      ...
                      //print_r($theme_data);
                    //echo '</pre>';
                    echo '<div class="sub-header-wrapper">';
                      echo '<div class="version-wrapper">';
                      echo '<h3 class="theme-tittle">'.ETHEME_THEME_NAME.'</h3>';
                      echo '<span class="theme-version">Version '.$theme_data->version.'</span>';
                      echo "</div>";
                    /* layouts form */
                    if ( get_option('etheme_purchase_code') != '' && get_option('etheme_purchase_code') > 0) {
                      echo  "<span class='purchase-code'>" . get_option('etheme_purchase_code') . "</span>";
                      echo "<a href='#' class='etheme-deactivator'>Deactivate theme</a>";
                    }
                    echo "</div>";
                    if ( $page['id'] == 'ot_theme_options' && OT_SHOW_NEW_LAYOUT == true )
                      ot_theme_options_layouts_form();
                ...
                if ( isset( $page['sections'] ) && count( $page['sections'] ) > 0 ) {
                  ...
                  foreach( (array) $page['sections'] as $section ) {
                    echo '<li id="tab_' . $section['id'] . '"><a href="#section_' . $section['id'] . '"><span class="dashicons-before '.$section['icon'].'"></span><span class="innner-tab-title">' . $section['title'] . '</span></a></li>';
                  }
