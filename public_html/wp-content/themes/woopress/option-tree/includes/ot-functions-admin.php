...
if ( ! function_exists( 'ot_admin_scripts' ) ) {
  ...
  function ot_admin_scripts() {
    ...
    wp_enqueue_script( 'ace-editor', 'https://cdnjs.cloudflare.com/ajax/libs/ace/1.2.9/ace.js', null, '1.2.9' );
...
function ot_fetch_google_fonts( $normalize = true, $force_rebuild = false ) {
  ...
  if ( $force_rebuild || ! is_array( $ot_google_fonts ) || empty( $ot_google_fonts ) ) {
    ...
    $ot_google_fonts_api_key = apply_filters( 'ot_google_fonts_api_key', 'AIzaSyDL3dxTiTf9YBlPvNvhHgtT4q-VyV0uwLo' );
