...
function custom_theme_options($return = false) {
   ...
   */
   ...
   $settings = apply_filters('et_options_tree_settings', array(
        ...
        array(
          'id'          => 'page_content_tab',
          'label'       => __( 'Page content', 'woopress' ),
          'std'         => '',
          'type'        => 'tab',
          'default'     => '',
          'section'     => 'typography',
        ...
        array(
          'id'          => 'main_header_area',
          'label'       => __( 'Main header area', 'woopress' ),
          'std'         => '',
          'type'        => 'tab',
          'default'     => '',
          'section'     => 'header',
        ...
        array(
          'id'          => 'cart_widget_sw',
          'label'       => __( 'Enable cart widget', 'woopress' ),
          'std'         => 'on',
          'type'        => 'on-off',
          'section'     => 'header',
          'default'     => '',
        ...
        array(
          'id'          => 'search_form_sw',
          'label'       => __( 'Enable search form in header', 'woopress' ),
          'std'         => 'on',
          'type'        => 'on-off',
          'section'     => 'header',
          'default'     => '',
  ...
  function ot_type_backup( $args = array() ) {
    ...
    echo '<div class="format-setting type-backup ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
        ...
        ?>
            ...
            <p class="importBtn"><a href="javascript:void(0)"><?php esc_html_e( 'Import Options', 'woopress' ); ?></a></p>

            <div class="import-block">

                <p><?php esc_html_e('Insert code you previously exported', 'woopress' ); ?></p>

                <textarea rows="16" cols="80" name="option_tree[new_options]"></textarea>

                <button type="submit" class="option-tree-ui-button blue light"><?php esc_html_e('Import', 'woopress' ); ?></button>

            </div>

            <div class="clear"></div>

            <p class="importBtn"><a href="javascript:void(0)"><?php esc_html_e( 'Export Options', 'woopress' ); ?></a></p>

            <div style="display:none;">
                <p><?php esc_html_e( 'Place this export code into the import text field in your new site and press "Import".', 'woopress' ); ?></p>
    ...
    echo '<div class="format-setting type-backup ' . ( $has_desc ? 'has-desc' : 'no-desc' ) . '">';
        ...
        if($demo_data_installed != 'yes') {
            ...
            ?>
                <div class="clear"></div>
                <br />
                <p><strong><?php esc_html_e('Note:', 'woopress' ); ?> </strong><?php esc_html_e('You have already installed base demo content.', 'woopress') ?></p>
            <?php
        }
        ?>
            <div class="clear"></div>
            ...
            <div class="et-theme-versions">
                <?php foreach($versions as $key => $value): ?>
                    <div class="theme-ver sort-<?php echo $value['cat']; ?>">
                        ...
                        <button class="option-tree-ui-button blue install-ver" data-ver="<?php echo $key; ?>" data-home_id="<?php echo $value['home_id']; ?>"><?php esc_html_e('Install version', 'woopress' ); ?></button>
...
if ( ! function_exists('et_recognized_link_color_fields') ) {
    function et_recognized_link_color_fields(){
        return array(
          'hover'   => _x( 'Hover', 'color picker', 'woopress' ),
          'active'  => _x( 'Active', 'color picker', 'woopress' ),
        );
    }
}
