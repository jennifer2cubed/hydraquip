	   ...
	   $setting_vc_gallery = array(
	    ...
	    $brands_params = array(
	      ...
	      'params' => array(
	        array(
	          "type" => "textfield",
	          "heading" => esc_html__("Title", 'woopress'),
	          "param_name" => "title"
	        ),
	        array(
	          "type" => "textfield",
	          "heading" => esc_html__("Number of categories", 'woopress'),
	          "param_name" => "number"
	        ),
	        /*
		    array(
	        ...
	        array(
	          'type' => 'autocomplete',
	          "heading" => esc_html__("Parent ID", 'woopress'),
	          "param_name" => "parent",
			  'settings' => array(
				'multiple' => false,
				'sortable' => false,
			  ...
			  'save_always' => true,
              "description" => esc_html__('Get direct children of this term (only terms whose explicit parent is this value). If 0 is passed, only top-level terms are returned. Default is an empty string.', 'woopress')
		    ),
		    array(
	          'type' => 'autocomplete',
	          "heading" => esc_html__("Categories IDs", 'woopress'),
	          "param_name" => "cat_ids",
			  'settings' => array(
				'multiple' => true,
				'sortable' => true,
			  ...
			  'save_always' => true,
              "description" => esc_html__('Write down ids of categories you want to show. ( It will work only if Parent ID area is empty. )', 'woopress')
		    ),
	        array(
	          "type" => "dropdown",
	          "heading" => esc_html__("Display type", 'woopress'),
	          "param_name" => "display_type",
	          "value" => array(
	              esc_html__("Grid", 'woopress') => 'grid',
	              esc_html__("Slider", 'woopress') => 'slider',
	              esc_html__("Menu", 'woopress') => 'menu'
	            )
	        ),
	        array(
	          "type" => "dropdown",
	          "heading" => esc_html__("Show empty categories", 'woopress'),
	          "param_name" => "hide_empty",
	          "value" => array(
	          	esc_html__("Hide", 'woopress') => 1,
	              esc_html__("Show", 'woopress') => 0
	            )
	        ),
	        array(
	          "type" => "textfield",
	    ...
	    $brands_params = array(
	      ...
	      'params' => array(
	        ...
	        array(
	          "type" => "dropdown",
	          "heading" => esc_html__("Number of columns", 'woopress'),
	          "param_name" => "columns",
	        ...
	        array(
	          "type" => "textfield",
	          "heading" => esc_html__("Number of brands", 'woopress'),
	          "param_name" => "number"
	        ),
		    array(
		      "type" => "dropdown",
	    ...
	    $search_params = array(
	      ...
	      'params' => array(
	        ...
	        array(
	          ...
	          "value" => array(
	          	esc_html__("Products", 'woopress') => 'product',
	          	esc_html__("Posts", 'woopress') => 'post',
	          	esc_html__("Portfolio", 'woopress') => 'etheme_portfolio',
	          	esc_html__("Pages", 'woopress') => 'page',
	          	esc_html__("Testimonial", 'woopress') => 'testimonial',
	          	esc_html__("All", 'woopress') => 'any',

	          )
	        ),
	        array(
	          "type" => "dropdown",
	          "heading" => esc_html__("Display images", 'woopress'),
	          "param_name" => "images",
	          "value" => array(
	              "",
	              esc_html__("Yes", 'woopress') => 1,
	              esc_html__("No", 'woopress') => 0
	            )
	        ),
	        // array(
	        //   "type" => "dropdown",
	        ...
	        array(
	          "type" => "textfield",
	          "heading" => esc_html__("Number of items", 'woopress'),
	          "param_name" => "count"
	        ),
	        array(
	          "type" => "textfield",
	    ...
	    $twitter_params = array(
	      ...
	      'params' => array(
	        ...
	        array(
	          "type" => "textfield",
	          "heading" => esc_html__("User account name", 'woopress'),
	          "param_name" => "user"
	        ),
	        array(
	          "type" => "textfield",
	          "heading" => esc_html__("Consumer Key", 'woopress'),
	          "param_name" => "consumer_key"
	        ),
	        array(
	          "type" => "textfield",
	          "heading" => esc_html__("Consumer Secret", 'woopress'),
	          "param_name" => "consumer_secret"
	        ),
	        array(
	          "type" => "textfield",
	          "heading" => esc_html__("User Token", 'woopress'),
	          "param_name" => "user_token"
	        ),
	        array(
	          "type" => "textfield",
	          "heading" => esc_html__("User Secret", 'woopress'),
	          "param_name" => "user_secret"
	        ),
	        array(
	          "type" => "textfield",
	          "heading" => esc_html__("Limit", 'woopress'),
	          "param_name" => "limit"
	        ),
	        array(
	          "type" => "textfield",
	    ...
	    $testimonials_params = array(
	      ...
	      'params' => array(
	        array(
	          ...
	          "heading" => esc_html__("Limit", 'woopress'),
	          "param_name" => "limit",
	          "description" => esc_html__('How many testimonials to show? Enter number.', 'woopress')
	        ),
			array(
			   "type" => "dropdown",
			   ...
			   "value" => array(
				   "",
				   esc_html__("Ascending", 'woopress') => 'id',
				   esc_html__("Descending", 'woopress') => 'menu_order'
				 )
			 ),
	        array(
	          "type" => "dropdown",
	        ...
	        array(
	          "type" => "textfield",
	          "heading" => esc_html__("Interval", 'woopress'),
	          "param_name" => "interval",
	          "description" => esc_html__('Interval between slides. In milliseconds. Default: 10000', 'woopress'),
	        ...
	        array(
	          ...
	          "value" => array(
	              "",
	              esc_html__("Hide", 'woopress') => false,
	              esc_html__("Show", 'woopress') => true
	            )
	        ),
	        array(
	          "type" => "textfield",
	          "heading" => esc_html__("Category", 'woopress'),
	          "param_name" => "category",
	          "description" => esc_html__('Display testimonials from category.', 'woopress')
	        ),
	      )
	    ...
	    $recent_posts_params = array(
	      ...
	      'params' => array(
	        ...
	        array(
	          ...
	          "value" => array(
	              "",
	              esc_html__("Enable", 'woopress') => 1,
	              esc_html__("Disable", 'woopress') => 0
	            )
	        ),
	        array(
	          "type" => "textfield",
	    ...
	    $team_member_params = array(
	      ...
	      'params' => array(
	        array(
	          'type' => 'textfield',
	          "heading" => esc_html__("Member name", 'woopress'),
	          "param_name" => "name"
	        ),
	        array(
	          'type' => 'textfield',
	          "heading" => esc_html__("Member email", 'woopress'),
	          "param_name" => "email"
	        ),
	        array(
	          'type' => 'textfield',
	          "heading" => esc_html__("Position", 'woopress'),
	          "param_name" => "position"
	        ),
	        array(
	          'type' => 'attach_image',
	          "heading" => esc_html__("Avatar", 'woopress'),
	          "param_name" => "img"
	        ),
	        array(
	          "type" => "textfield",
	        ...
	        array(
	          ...
	          "value" => array(
	              "",
	              esc_html__("Vertical", 'woopress') => 1,
	              esc_html__("Horizontal", 'woopress') => 2
	            )
	        ),
	        array(
	          'type' => 'textfield',
	          "heading" => esc_html__("Twitter link", 'woopress'),
	          "param_name" => "twitter"
	        ),
	        array(
	          'type' => 'textfield',
	          "heading" => esc_html__("Facebook link", 'woopress'),
	          "param_name" => "facebook"
	        ),
	        array(
	          'type' => 'textfield',
	          "heading" => esc_html__("Linkedin", 'woopress'),
	          "param_name" => "linkedin"
	        ),
	        array(
	          'type' => 'textfield',
	          "heading" => esc_html__("Skype name", 'woopress'),
	          "param_name" => "skype"
	        ),
	        array(
	          'type' => 'textfield',
	          "heading" => esc_html__("Instagram", 'woopress'),
	    ...
	    $icon_params = array(
	      ...
	      'params' => array(
	        ...
	        array(
	          ...
	          "param_name" => "size",
	          "description" => esc_html__('For example: 64', 'woopress')
	        ),
	        array(
	          'type' => 'colorpicker',
	          "heading" => esc_html__("Color", 'woopress'),
	          "param_name" => "color"
	        ),
	        array(
	          "type" => "textfield",
	    ...
	    $icon_box_params = array(
	      ...
	      'params' => array(
	        array(
	          'type' => 'textfield',
	          "heading" => esc_html__("Box title", 'woopress'),
	          "param_name" => "title"
	        ),
	        array(
	          'type' => 'icon',
	        ...
	        array(
	          'type' => 'colorpicker',
	          "heading" => esc_html__("Icon Color", 'woopress'),
	          "param_name" => "color"
	        ),
	        array(
	          'type' => 'colorpicker',
	          "heading" => esc_html__("Background Color", 'woopress'),
	          "param_name" => "bg_color"
	        ),
	        array(
	          'type' => 'colorpicker',
	          "heading" => esc_html__("Icon Color [HOVER]", 'woopress'),
	          "param_name" => "color_hover"
	        ),
	        array(
	          'type' => 'colorpicker',
	          "heading" => esc_html__("Background Color [HOVER]", 'woopress'),
	        ...
	        array(
	          ...
	          "value" => array(
	              "",
	              esc_html__("Top", 'woopress') => 'top',
	              esc_html__("Left", 'woopress') => 'left'
	            )
	        ),
	        array(
	          "type" => "dropdown",
	          ...
	          "value" => array(
	              esc_html__("Encircled", 'woopress') => 'encircled',
	              esc_html__("Small", 'woopress') => 'small',
	              esc_html__("Large", 'woopress') => 'large'
	            )
	        ),
	        array(
	          "type" => "textfield",
	    ...
	    $banner_params = array(
	      ...
	      'params' => array(
	        array(
	          'type' => 'attach_image',
	          "heading" => esc_html__("Banner Image", 'woopress'),
	          "param_name" => "img"
	        ),
	        array(
	          "type" => "textfield",
	        ...
	        array(
	          "type" => "dropdown",
	          "heading" => esc_html__("Horizontal align", 'woopress'),
	          "param_name" => "align",
	          "value" => array( "", esc_html__("Left", 'woopress') => "left", esc_html__("Center", 'woopress') => "center", esc_html__("Right", 'woopress') => "right")
	        ),
	        array(
	          "type" => "dropdown",
	          "heading" => esc_html__("Vertical align", 'woopress'),
	          "param_name" => "valign",
	          "value" => array( esc_html__("Top", 'woopress') => "top", esc_html__("Middle", 'woopress') => "middle", esc_html__("Bottom", 'woopress') => "bottom")
	        ),
	        array(
	          "type" => "dropdown",
	          "heading" => esc_html__("Hover effect", 'woopress'),
	          "param_name" => "hover",
	          "value" => array( "", esc_html__("zoom", 'woopress') => "zoom", esc_html__("fade", 'woopress') => "fade")
	        ),
		    array(
		      "type" => 'checkbox',
		      "heading" => esc_html__("Responsive fonts", 'woopress'),
	    ...
	    $ptable_params = array(
	      ...
	      'params' => array(
	        ...
	        array(
	          ...
	          "param_name" => "style",
	          "value" => array( "", esc_html__("default", 'woopress') => "default", esc_html__("Style 2", 'woopress') => "style2")
	        ),
	        array(
	          "type" => "textfield",
	          "heading" => esc_html__("Extra Class", 'woopress'),
	    ...
	    $fpost_params = array(
	      ...
	      'params' => array(
	        ...
	        array(
	          "type" => "textfield",
	          "heading" => esc_html__("Post ID", 'woopress'),
	          "param_name" => "id"
	        ),
	        array(
	          "type" => "dropdown",
	          "heading" => esc_html__("Show more posts link", 'woopress'),
	          "param_name" => "more_posts",
	          "value" => array( "", esc_html__("Show", 'woopress') => 1, esc_html__("Hide", 'woopress') => 0)
	        ),
	        array(
	          "type" => "textfield",
	          "heading" => esc_html__("Extra Class", 'woopress'),
	    ...
	    $teaser_box_params = array(
	      ...
	      'params' => array(
	        ...
	        array(
	          'type' => 'attach_image',
	          "heading" => esc_html__("Image", 'woopress'),
	          "param_name" => "img"
	        ),
	        array(
	          "type" => "textfield",
	    ...
	    $fpost_params = array(
	      ...
	      'params' => array(
	        ...
	        array(
	          'type' => 'autocomplete',
	          "heading" => esc_html__("IDs", 'woopress'),
	          "param_name" => "ids",
			  'settings' => array(
				  'multiple' => true,
				  'sortable' => true,
	        ...
	        array(
	          "type" => "textfield",
	          "heading" => esc_html__("SKUs", 'woopress'),
	          "param_name" => "skus"
	        ),
	       	array(
	          "type" => "dropdown",
	          ...
	          "value" => array(
	          	...
	          	esc_html__("Date", 'woopress') => 'date',
	          	esc_html__("Comments", 'woopress') => 'comment_count',
	          	esc_html__("Title", 'woopress') => 'title',
	          	esc_html__("ID", 'woopress') => 'ID',
	          	esc_html__('Custom Order') => 'postesc_html__in',
	          	esc_html__("Rand", 'woopress') => 'rand',
	          )
	        ),
	        array(
	          "type" => "dropdown",
	          "heading" => esc_html__("Sort order", 'woopress'),
	          "param_name" => "orderby",
	          "value" => array(
	          	esc_html__("Ascending", 'woopress') => 'ASC',
	          	esc_html__("Descending", 'woopress') => 'DESC',
	          )
	        ),
	        array(
	          "type" => "dropdown",
	          ...
	          "value" => array(
	          	'' => '',
	          	esc_html__("Disable", 'woopress') => 'disable',
	          	esc_html__("Swap", 'woopress') => 'swap',
	          	esc_html__("Images Slider", 'woopress') => 'slider',
	          	esc_html__("Mask with information", 'woopress') => 'mask',
	          )
	        ),
	        array(
	          "type" => "dropdown",
	          "heading" => esc_html__("Display Type", 'woopress'),
	          "param_name" => "type",
	          "value" => array( esc_html__("Slider", 'woopress') => 'slider',esc_html__("Slider full width (LOOK BOOK)", 'woopress') => 'full-width', esc_html__("Grid", 'woopress') => 'grid', esc_html__("List", 'woopress') => 'list')
	        ),
	        array(
	          "type" => "dropdown",
	          "dependency" => Array('element' => "type", 'value' => array('full-width')),
	          "heading" => esc_html__("Static block for the first slide of the LOOK BOOK", 'woopress'),
	          "param_name" => "block_id",
	          "value" => $static_blocks
	        ),
	        array(
	          "type" => "textfield",
	          "heading" => esc_html__("Columns", 'woopress'),
	          "param_name" => "columns",
	          "dependency" => Array('element' => "type", 'value' => array('grid'))
	        ),
	        array(
	          "type" => "dropdown",
	          "heading" => esc_html__("Product view", 'woopress'),
	          "param_name" => "style",
	          "dependency" => Array('element' => "type", 'value' => array('slider')),
	          "value" => array( esc_html__("Default", 'woopress') => 'default', esc_html__("Advanced", 'woopress') => 'advanced')
	        ),
	        array(
	          "type" => "textfield",
	          "heading" => esc_html__("Number of items on desktop", 'woopress'),
	        ...
	        array(
	          "type" => "dropdown",
	          "heading" => esc_html__("Products type", 'woopress'),
	          "param_name" => "products",
	          "value" => array( esc_html__("All", 'woopress') => '', esc_html__("Featured", 'woopress') => 'featured', esc_html__("New", 'woopress') => 'new', esc_html__("Sale", 'woopress') => 'sale', esc_html__("Recently viewed", 'woopress') => 'recently_viewed', esc_html__("Bestsellings", 'woopress') => 'bestsellings')
	        ),
	        array(
	          "type" => "dropdown",
	          "heading" => esc_html__("Hide out of stock products", 'woopress'),
	        ...
	        array(
	          "type" => "textfield",
	          "heading" => esc_html__("Categories or Tags IDs", 'woopress'),
	          "param_name" => "categories"
	        )
	      )
	    ...
	    $follow_params = array(
          ...
          'params' => array(
            ...
            array(
              "type" => "checkbox",
              "heading" => esc_html__("Colorfull icons", 'woopress'),
              "param_name" => "colorfull",
            ),
            array(
              "type" => "dropdown",
              "heading" => esc_html__("Link Target", 'woopress'),
              "param_name" => "target",
              "value" => array( esc_html__("Blank", 'woopress') => "_blank", esc_html__("Current window", 'woopress') => "_self")
            ),
            array(
              "type" => "dropdown",
              "heading" => esc_html__("Size", 'woopress'),
              "param_name" => "size",
              "value" => array( esc_html__("Normal", 'woopress') => "normal", esc_html__("Large", 'woopress') => "large", esc_html__("Small", 'woopress') => "small"),
            ),
            array(
              "type" => "textfield",
	    ...
	    $et_top_cart = array(
          ...
          'params' => array(
     		array(
	          ...
	          "heading" => esc_html__("Style", 'woopress'),
	          "param_name" => "color",
	          "value" => array( esc_html__( 'Dark', 'woopress' ) => 'dark', esc_html__( 'light', 'woopress' ) => 'light' ),
	        ),
            array(
	          "type" => "dropdown",
	          "heading" => esc_html__("Enable dropdown", 'woopress'),
	          "param_name" => "dropdown",
	          "value" => array( esc_html__( 'on', 'woopress' ) => 'on', esc_html__( 'off', 'woopress' ) => 'off'),
	        ),
	        array(
              "type" => "dropdown",
              "heading" => esc_html__("Position", 'woopress'),
              "param_name" => "position",
              "value" => array( esc_html__( "Right", 'woopress' ) => "right", esc_html__( "Left", 'woopress' ) => "left", esc_html__( "Center", 'woopress') => "center" ),
            ),
	        array(
              "type" => "textfield",
              "heading" => esc_html__("Extra class name", 'woopress'),
	    ...
	    $et_menu = array(
          ...
          'params' => array(
          	 array(
				...
				"heading" => esc_html__("Position", 'woopress'),
				"param_name" => "position",
				"value" => array( esc_html__("Left", 'woopress') => "left", esc_html__("Right", 'woopress') => "right", esc_html__("Center", 'woopress') => "center"),
            ),
            array(
				"type" => 'checkbox',
				"heading" => esc_html__("Mobile Trigger", 'woopress' ),
				"param_name" => "mobile",
				"value" => Array(esc_html__("Yes, please", 'woopress' ) => 'on')
		    ),
            array(
				"type" => "textfield",
				"heading" => esc_html__( "Extra class name", 'woopress' ),
	    ...
	    $et_top_search = array(
          ...
          'params' => array(
            array(
	          "type" => "dropdown",
	          "heading" => esc_html__("View", 'woopress'),
	          "param_name" => "view",
	          "value" => array( esc_html__( 'Popup', 'woopress' ) => 'modal', esc_html__( 'Hover', 'woopress' ) => 'hover', esc_html__( 'Default', 'woopress' ) => 'default'),
	        ),
	        array(
              "type" => "textfield",
              "heading" => esc_html__("Extra class name", 'woopress'),
	    ...
	    $et_links = array(
          ...
          'params' => array(
          	array(
              "type" => "colorpicker",
              "heading" => esc_html__("Links text color", 'woopress'),
              "param_name" => "color",
            ),
            array(
              "type" => "colorpicker",
              "heading" => esc_html__("Links hover text color", 'woopress'),
	        ...
	        array(
              "type" => "checkbox",
              "heading" => esc_html__("Enable Register Link", 'woopress'),
              "param_name" => "register",
            ),
            array(
              "type" => "checkbox",
              "heading" => esc_html__("Enable Newsletter Link", 'woopress'),
        ...
        $et_instagram = array(
	      ...
	      'params' => array_merge(array(
	        ...
	        array(
	          "type" => "textfield",
	          "heading" => esc_html__("Username or hashtag", 'woopress'),
	          "param_name" => "username",
	        ),
	        array(
	          "type" => "textfield",
	          "heading" => esc_html__("Numer of photos", 'woopress'),
	          "param_name" => "number",
	        ),
			array(
				'type' => 'dropdown',
				'heading' => esc_html__( 'Photo size', 'woopress' ),
				'param_name' => 'size',
				'value' => array(
					__( 'Thumbnail', 'woopress' ) => 'thumbnail',
					__( 'Medium', 'woopress' ) => 'medium',
					__( 'Large', 'woopress' ) => 'large',
				),
			),
			array(
				'type' => 'dropdown',
			...
			array(
				'type' => 'dropdown',
				'heading' => esc_html__( 'Open links in', 'woopress' ),
				'param_name' => 'target',
				'value' => array(
					__( 'Current window (_self)', 'woopress' ) => '_self',
					__( 'New window (_blank)', 'woopress' ) => '_blank',
				),
			),
			array(
				'type' => 'dropdown',
				'heading' => esc_html__( 'Photo filters', 'woopress' ),
				'param_name' => 'filter_img',
				'value' => array(
					__('None', 'woopress') => '',
					__( 'Grey', 'woopress' ) => 'grey-scale',
					__( 'Saturate', 'woopress' ) => 'saturate',
					__( 'Contrast', 'woopress' ) => 'contrast',
				),
			),
	        array(
	          "type" => "textfield",
	          "heading" => esc_html__("Link text", 'woopress'),
	          "param_name" => "link",
	        ),
	        array(
	          "type" => "checkbox",
	          "heading" => esc_html__("Additional information", 'woopress'),
	          "param_name" => "info",
	        ),
			array(
				'type' => 'checkbox',
				'heading' => esc_html__( 'Slider', 'woopress' ),
				'param_name' => 'slider',
				'value' => array(
					__( 'Yes', 'woopress' ) => 1,
				),
			...
			array(
				'type' => 'checkbox',
				'heading' => esc_html__( 'Without spacing', 'woopress' ),
				'param_name' => 'spacing',
				'value' => array(
					__( 'Yes', 'woopress' ) => 1,
				),
