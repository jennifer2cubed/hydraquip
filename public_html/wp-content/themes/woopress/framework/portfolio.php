...
if ( ! class_exists( 'ETheme_Post_Types' ) ) :
	...
	class ETheme_Post_Types {
		...
		public function portfolio_init() {
			...
			$labels = array(
				'name' => _x('Projects', 'post type general name', 'woopress'),
				'singular_name' => _x('Project', 'post type singular name', 'woopress'),
				'add_new' => _x('Add New', 'project', 'woopress'),
				'add_new_item' => esc_html__('Add New Project', 'woopress'),
				'edit_item' => esc_html__('Edit Project', 'woopress'),
				'new_item' => esc_html__('New Project', 'woopress'),
				'view_item' => esc_html__('View Project', 'woopress'),
				'search_items' => esc_html__('Search Projects', 'woopress'),
				'not_found' =>  esc_html__('No projects found', 'woopress'),
				'not_found_in_trash' => esc_html__('No projects found in Trash', 'woopress'),
				'parent_item_colon' => '',
				'menu_name' => 'Portfolio'
			...
			$labels = array(
				'name' => _x( 'Tags', 'taxonomy general name', 'woopress' ),
				'singular_name' => _x( 'Tag', 'taxonomy singular name', 'woopress' ),
				'search_items' =>  esc_html__( 'Search Types', 'woopress' ),
				'all_items' => esc_html__( 'All Tags', 'woopress' ),
				'parent_item' => esc_html__( 'Parent Tag', 'woopress' ),
				'parent_item_colon' => esc_html__( 'Parent Tag:', 'woopress' ),
				'edit_item' => esc_html__( 'Edit Tags', 'woopress' ),
				'update_item' => esc_html__( 'Update Tag', 'woopress' ),
				'add_new_item' => esc_html__( 'Add New Tag', 'woopress' ),
				'new_item_name' => esc_html__( 'New Tag Name', 'woopress' ),
			);
			...
			$labels2 = array(
				'name' => _x( 'Portfolio Categories', 'taxonomy general name', 'woopress' ),
				'singular_name' => _x( 'Category', 'taxonomy singular name', 'woopress' ),
				'search_items' =>  esc_html__( 'Search Types', 'woopress' ),
				'all_items' => esc_html__( 'All Categories', 'woopress' ),
				'parent_item' => esc_html__( 'Parent Category', 'woopress' ),
				'parent_item_colon' => esc_html__( 'Parent Category:', 'woopress' ),
				'edit_item' => esc_html__( 'Edit Categories', 'woopress' ),
				'update_item' => esc_html__( 'Update Category', 'woopress' ),
				'add_new_item' => esc_html__( 'Add New Category', 'woopress' ),
				'new_item_name' => esc_html__( 'New Category Name', 'woopress' ),
			);
		...
		public function custom_type_settings() {
			...
			add_settings_section(
				'et_section',
				__( '8theme permalink settings' , 'woopress' ),
			...
			add_settings_field(
				'portfolio_cat_base',
				__( 'Portfolio category base' , 'woopress' ),
		...
		public function section_callback() {
			...
			echo '
				<p>' . esc_html__( '8theme portfolio permalink settings.' , 'woopress' ) . '</p>
				</tbody></tr></th>
				<table class="form-table">
						<tbody>
							<tr>
								<th scope="row"><label><input class="et-inp" type="radio" name="et_permalink" value="portfolio_def" ' . $checked['portfolio_def'] . ' >' . esc_html__( 'Default' , 'woopress' ) . '</label></th>
								<td><code>' . esc_html( home_url() ) . '/portfolio-base/sample-project/</code></td>
							</tr>
							<tr>
								<th scope="row"><label><input class="et-inp" type="radio" name="et_permalink" value="portfolio_cat_base" ' . $checked['portfolio_cat_base'] . '>' . esc_html__( 'Portfolio category base' , 'woopress' ) . '</label></th>
								<td><code>' . esc_html( home_url() ) . '/portfolio-base/portfolio-category/sample-project/</code></td>
							</tr>
							<tr>
								<th scope="row"><label><input id="portfolio-custom-base-select" type="radio" name="et_permalink" value="portfolio_custom_base" ' . $checked['portfolio_custom_base'] . '>' . esc_html__( 'Portfolio custom Base' , 'woopress' ) . '</label></th>
...
function get_etheme_portfolio($categories = false, $limit = false, $show_pagination = true) {
		...
		if ( $loop->have_posts() ) : ?>
			<div>
				<ul class="portfolio-filters">
					<li><a href="#" data-filter="*" class="btn big active"><?php esc_html_e('Show All', 'woopress'); ?></a></li>
						<?php
	...
	<?php else: ?>
		...
		<h3><?php esc_html_e('No projects were found!', 'woopress') ?></h3>
