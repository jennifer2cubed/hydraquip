	...
	class Envato_Theme_Setup_Wizard {
		...
		public function envato_setup_introduction() {
			...
			<!-- 		<li>
				...
				<p style="border:2px solid #ff4242; color:#c33434; padding:10px;">Important! If you need to update woopress theme, just Cancel the setup wizard.
...
Go to Theme Options and Activate theme with your Purchase code.</p>
				...
				<img src="<?php echo ETHEME_CODE_IMAGES_URL; ?>/big-eight.png" alt="eight theme" class="elogo">
				<h1><?php printf( esc_html__( 'Welcome to WooPress Setup Wizard', 'etheme' ), wp_get_theme() ); ?></h1>
				<p><?php printf( esc_html__( 'Thank you for choosing our WooPress template.', 'etheme' ), wp_get_theme() ); ?></p>
...
Once imported, this content can be managed from the WordPress dashboard.  </p>
		...
		public function envato_setup_updates() {
			...
			<?php if ( etheme_is_activated() ): ?>
				...
				<h2><?php esc_html_e('Thank you for activation', 'woopress'); ?></h2>
				<p><?php esc_html_e('Now you have lifetime updates, 6 months of free top-notch support, 24/7 live support and much more.', 'woopress'); ?></p>
				...
				<?php else: ?>
					<p><?php esc_html_e('We see that the server configurations do not follow the requirements. So, please, install a theme and plugins manually. You can implement this via Theme Options>>Import/Export. The following ', 'woopress'); ?><a href="https://www.youtube.com/watch?v=bHE_UhSJM10" target="blank"><?php esc_html_e('Video tutorial', 'woopress'); ?> </a><?php esc_html_e('can assist you with that. If you encounter any difficulties, please, contact us in a Live Chat that can found in the right bottom corner of your Dashboard.', 'woopress'); ?><br> <?php esc_html_e('Thank you for using our theme.', 'woopress'); ?></p><br><br>
					<div class="support-includes">
						...
						<div class="envato-setup-next-steps-last">
							<p><?php esc_html_e('How to install theme manually', 'woopress'); ?></p>
							<br>
			...
			<?php else: ?>
				...
				<p><?php _e('Use your purchase code to activate woopress template. Please, note, that you won’t be able to use it without activation.<br>A purchase code (license) is only valid for One Project. Do you want to use this theme for a one more project? Purchase a <a href="https://themeforest.net/item/xstore-responsive-woocommerce-theme/9751050?license=regular&open_purchase_for_item_id=9751050&purchasable=source&ref=8theme">new license here</a> to get a new purchase code.', 'etheme'); ?></p>
				<h3><?php esc_html_e('To find your Purchase code', 'etheme'); ?></h3>
				<img src="<?php echo ETHEME_CODE_IMAGES_URL; ?>/purchase-code-bc.png">
				<br><br>
				<p><?php esc_html_e('Activate woopress template and get lifetime updates, 6 months of free top-notch support, 24/7 live support and much more.', 'etheme'); ?></p>
		...
		?>
			<h1>Setup woopress Child Theme (Optional)</h1>
			...
			<?php
				...
				$theme = get_option('etheme_has_child') ? wp_get_theme(get_option('etheme_has_child') )->Name : 'Woopress Child';
			 ?>
			...
			<p class="envato-setup-actions step">
				...
				<a href="<?php echo esc_url( $this->get_next_step_link() ); ?>" class="et-button"><?php _e( 'Skip this step', 'envato_setup' ); ?></a>

			</p>
			</form>
			<?php } else { ?>
			<p class="envato-setup-actions step">
				<a href="<?php echo esc_url( $this->get_next_step_link() ); ?>" class="et-button button-active"><?php _e( 'Continue', 'etheme' ); ?></a>
			</p>
			<?php } ?>
			<?php
		}
		...
		private function _make_child_theme( $new_theme_title ) {
				...
				$parent_theme_title = 'woopress';
				$parent_theme_template = 'woopress';
		...
		public function envato_setup_help_support() {
			...
			<ul class="support-blocks">
				<li>
					...
					Live Chat 24/7<br> <a href="http://8theme.com/demo/woopress/" target="_blank">check</a></li>
				<li>
		...
		public function envato_setup_ready() {
			...
			<p>Congratulations! Woopress theme has been activated on your website and ready to use. Login to your WordPress dashboard to make all the necessary changes and upload your content. </p>
			...
			<div class="support-includes">
				...
				<div class="envato-setup-next-steps-last">
					...
					<br>
					<img src="<?php echo ETHEME_CODE_IMAGES_URL . '/no-video.jpg'; ?>" alt="rate">
				</div>
			</div>
			<p class="envato-setup-actions step">
				<a class="et-button button-active" href="<?php echo esc_url( home_url() ); ?>"><?php esc_html_e( 'View your new website!', 'etheme' ); ?></a>
