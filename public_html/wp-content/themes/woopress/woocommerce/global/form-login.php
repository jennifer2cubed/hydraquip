...
<form method="post" class="login" <?php if ( $hidden ) echo 'style="display:none;"'; ?>>
	...
	<p class="form-row">
		...
		<input type="submit" class="button" name="login" value="<?php esc_attr_e( 'Login', 'woopress' ); ?>" />
	...
	<p class="lost_password">
		<a href="<?php echo esc_url( wc_lostpassword_url() ); ?>"><?php esc_html_e( 'Lost your password?', 'woopress' ); ?></a>
	</p>
