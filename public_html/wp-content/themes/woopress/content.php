...
*/
    ...
    $post_content = get_the_content('<span class="btn big filled pull-right read-more">'.__('Read More', 'woopress').'</span>');
...
<article <?php post_class($postClass); ?> id="post-<?php the_ID(); ?>" >
	<div>
		<?php if($post_format == 'quote' || $post_format == 'video'): ?>
	            ...
	            <?php the_excerpt(); ?>
	        	<a href="<?php the_permalink(); ?>" class="more-link"><span class="btn big filled pull-right read-more"><?php esc_html_e('Read More', 'woopress'); ?></span></a>
		...
		<?php elseif(has_post_thumbnail()): ?>
			<div class="wp-picture">
				...
				<div class="zoom">
					<div class="btn_group">
						<a href="<?php echo etheme_get_image(); ?>" class="btn btn-black xmedium-btn" rel="pphoto"><span><?php esc_html_e('View large', 'woopress'); ?></span></a>
						<a href="<?php the_permalink(); ?>" class="btn btn-black xmedium-btn"><span><?php esc_html_e('More details', 'woopress'); ?></span></a>
					</div>
					<i class="bg"></i>
				</div>
			</div>
		...
		<?php if($post_format != 'quote'): ?>
	        ...
	        <?php if(etheme_get_option('blog_byline') && etheme_get_option('blog_layout') != 'timeline'): ?>
	            <div class="meta-post">
	                    ...
	                    <?php esc_html_e('by', 'woopress');?> <span class="vcard"> <span class="fn"><?php the_author_posts_link(); ?></span></span>
	        ...
	        <?php elseif(etheme_get_option('blog_byline') && etheme_get_option('blog_layout') == 'timeline'): ?>
	            <div class="meta-post">
	                    <?php esc_html_e('Posted by', 'woopress');?> <?php the_author_posts_link(); ?>
	                    <?php // Display Comments
