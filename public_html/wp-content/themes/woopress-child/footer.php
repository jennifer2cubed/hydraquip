...
?>
    <div class="he_newsletter_container">
		<div class="he_newsletter">
			<div class="row">
				<div class="col-md-6">
					<span>
						<i class="fa fa-paper-plane-o" aria-hidden="true"></i> Sign up to Newsletter
					<span>
				</div>
				<div class="col-md-6">
	...
	<?php if ( etheme_get_option('fixed_ppopup') ): ?>
                    <div class="popup_link fixed-popup button <?php if(!etheme_get_option('promo_link')): ?>hidden<?php endif; ?>" <?php if (etheme_get_option('pp_button_bg')): echo 'style="background-color: ' . etheme_get_option('pp_button_bg') . '"'; endif; ?>><a class="etheme-popup <?php echo (etheme_get_option('promo_auto_open')) ? 'open-click': '' ; ?>" href="#etheme-popup"><?php if ( etheme_get_option('pp_title') == '' ) { esc_html_e('Newsletter', 'woopress'); } else { echo etheme_get_option('pp_title'); } ?></a></div>
      <?php  endif; ?>
