...
<div class="row" id="customer_login">
	...
	<div class="col-sm-6 border_right">
		...
		<form method="post" class="login login-form woocommerce-form woocommerce-form-login">
			...
			<h5><?php esc_html_e( 'Login', 'woopress' ); ?></h5><br>
			<span class="blue_bot_line"></span><span class="gray_bot_line"></span>
...
<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
	...
	<div class="col-sm-6 border-left">
		...
		<form method="post" class="register">
			...
			<h5><?php esc_html_e( 'Register', 'woopress' ); ?></h5><br>
			<span class="blue_bot_line"></span><span class="gray_bot_line"></span>
			
			<p>Create Your very own Hydraquip Account</p>
		...
		<p>
		<i class="fa fa-check" aria-hidden="true"></i> Speed your way through the checkout<br>
		<i class="fa fa-check" aria-hidden="true"></i> Track your orders easily<br>
		<i class="fa fa-check" aria-hidden="true"></i> Keep a record of all your purchases<br>
		</p>
	</div>
